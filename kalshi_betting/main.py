...
def _dedup_pairs(primary: list, secondary: list) -> list:
    ...
    Args:
        primary (list): List of CandidatePair objects from find_ts_pairs()
...
def _run_dev(client, args) -> None:
    ...
    time_series_pairs = find_ts_pairs(client, held_tickers=set(), markets=markets)
...
def _run_prod(client, args) -> None:
    ...
    time_series_pairs = find_ts_pairs(client, held_tickers, markets)
