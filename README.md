...
backtest.py (CLI)
  ...
  └─ dashboard.generate_dashboard()          — write HTML report: k-selector section plus the scenario-
                                                ...
                                                and a sticky filter bar whose every band x Kalshi category
                                                x tag view is computed here, packed into the page and
                                                swapped in by a small script
```
